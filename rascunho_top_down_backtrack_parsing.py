...
'''
  Limitacoes
    * Gramatica fixa no codigo
    * Nao pode ter mais do que 9 regras de producao (vai falhar no backtracking)
    * Esta aceitando a cadeia quando w foi formado, mas ainda tem simbolos em beta
'''

w = input("entre a cadeia: ")
terminals = ["a", "b", "c"]
non_terminals = ["S"]
prod_rules_S = ["aSbS", "aS", "c"]
enumerable_prod_rules = ["S0", "S1", "S2"]

# Variaveis globais (remover depois)
